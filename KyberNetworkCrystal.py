...
class KyberNetwork(BaseModul.BaseModul):

    NAME                = "Kyber Network Crystal"    # Name
    SYMBOL              = "KNC"             # Token Symbol
    CROWDSALE_ADDRESS   = '0xd6cd31f283d24cfb442cba1bcf42290c07c15792'              # Contract of Crowdsale, leave '0x' if now separate contract was used
    ERC20_ADDRESS       = '0xdd974d5c2e2928dea5f71b9825b8b646686bd200'              # Address of ERC20-Contract 
