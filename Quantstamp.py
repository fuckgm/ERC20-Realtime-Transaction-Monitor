...
class Quantstamp(BaseModul.BaseModul):

    NAME                = "Quantstamp"    # Name
    SYMBOL              = "QSP"             # Token Symbol
    CROWDSALE_ADDRESS   = '0x'              # Contract of Crowdsale, leave '0x' if no separate contract was used
    ERC20_ADDRESS       = '0x99ea4db9ee77acd40b119bd1dc4e33e1c070b80d'              # Address of ERC20-Contract 
