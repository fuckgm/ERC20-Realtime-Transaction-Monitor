...
class RipioCreditNetwork(BaseModul.BaseModul):

    NAME                = "RipioCreditNetwork"    # Name
    SYMBOL              = "RCN"             # Token Symbol
    CROWDSALE_ADDRESS   = '0x'              # Contract of Crowdsale, leave '0x' if no separate contract was used
    ERC20_ADDRESS       = '0xf970b8e36e23f7fc3fd752eea86f8be8d83375a6'              # Address of ERC20-Contract 
