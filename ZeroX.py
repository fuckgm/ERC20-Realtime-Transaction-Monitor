...
class ZeroX(BaseModul.BaseModul):

    NAME                = "ZeroX Protocol"    # Name
    SYMBOL              = "ZRX"             # Token Symbol
    CROWDSALE_ADDRESS   = '0x'              # Contract of Crowdsale, leave '0x' if no separate contract was used
    ERC20_ADDRESS       = '0xe41d2489571d322189246dafa5ebde1f4699f498'              # Address of ERC20-Contract 
